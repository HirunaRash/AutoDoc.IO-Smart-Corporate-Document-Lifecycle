        ...
        <div className="animate-fade-up" style={{ width: "100%", maxWidth: 460 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "2.5rem", gap: "1rem" }}>
            <div style={{
              ...
              <div style={{
                ...
                boxShadow: "4px 4px 10px rgba(108,99,255,0.4), -2px -2px 6px rgba(255,255,255,0.2)",
                display: "flex", alignItems: "center", justifyContent: "center",
              }}>
            ...
            <div>
              <h1 style={{ fontSize: "1.6rem", fontWeight: 900, color: "var(--neu-text)", letterSpacing: "-0.02em", lineHeight: 1 }}>
                AutoDoc<span style={{ color: "#6c63ff" }}>.IO</span>
              </h1>
              <p style={{ fontSize: "0.65rem", color: "var(--neu-text-muted)", letterSpacing: "0.15em", textTransform: "uppercase", fontWeight: 600 }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      ...(active ? {
                        background: "linear-gradient(145deg, #7c74ff, #5a52e0)",
                        color: "#fff",
                        boxShadow: "4px 4px 12px rgba(108,99,255,0.4), -2px -2px 6px rgba(255,255,255,0.15)",
                      } : {
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.2rem" }}>
              {isRegister && (
                <div className="animate-fade-up">
                  <NeuInput label="Full Name" placeholder="Your Name" value={fullName} onChange={setFullName} />
                </div>
              )}
              ...
              {error && (
                <div className="animate-fade-in" style={{
                  padding: "0.85rem 1rem", borderRadius: 14, fontSize: "0.82rem",
                  color: "#dc2626", background: "#fee2e2",
                  boxShadow: "inset 3px 3px 8px rgba(220,38,38,0.12), inset -3px -3px 8px rgba(255,255,255,0.7)",
              ...
              <button
                ...
                style={{ width: "100%", padding: "1rem", borderRadius: 16, fontSize: "0.95rem", border: "none", cursor: loading ? "not-allowed" : "pointer", marginTop: "0.5rem" }}
              >
                {loading ? (
          ...
          <div style={{ display: "flex", gap: "0.6rem", justifyContent: "center", marginTop: "2rem", flexWrap: "wrap" }}>
            {["🧠 AI Classification", "⚡ Auto Summary", "🔍 Semantic Search"].map((f) => (
              <span key={f} style={{
                fontSize: "0.72rem", fontWeight: 600, color: "var(--neu-text-muted)",
